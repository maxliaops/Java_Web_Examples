...
<body>
  <form name="form1" action="chuchai_add_cl.jsp" method="post">
<table width="627" height="343" border="0" cellpadding="0" cellspacing="0" background="../Images/noword.jpg">
  <script language="javascript">
  ...
  <tr>
    <td height="350" valign="top"><table width="617" height="350" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="25" colspan="8">&nbsp;&nbsp;<br><span class="STYLE2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;出差登记</span></td>
      </tr>
      <tr>
      ...
      <tr>
        <td width="93" height="211"><span class="STYLE2">出差地区/原因</span></td>
        <td colspan="7"><label>
          <textarea name="chuarea" cols="70" rows="13" wrap="physical" id="chuarea"></textarea>
        </label></td>
      </tr>
      <tr>
