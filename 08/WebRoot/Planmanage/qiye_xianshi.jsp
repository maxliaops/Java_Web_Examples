 ...
 <table width="458" height="459" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" background="../Images/waichudeng.gif"><table width="442" height="448" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td height="42" valign="bottom">&nbsp;&nbsp;&nbsp;&nbsp;<span class="STYLE3">企业计划详细信息</span></td>
      </tr>
      <tr>
        <td height="406"><table width="427" height="298" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="136"><input name="textfield" type="text" value="<%=qiye.getName1()%>" size="20">
            ...
            <td width="162"><div align="center" class="STYLE3">
              <div align="left">
                <input name="textfield" type="text" value="<%=qiye.getTitle()%>" size="20">
                </div>
            </div></td>
          </tr>
          <tr>
            ...
            <td height="187" colspan="3" valign="middle" class="STYLE3"><textarea name="content" cols="48" rows="17" id="content"><%=qiye.getContent()%></textarea></td>
            </tr>
          <tr>
            <td height="15"><div align="center" class="STYLE3">发表时间</div></td>
            <td height="15"><div align="center" class="STYLE3">
              <div align="left">
                <input name="textfield" type="text" value="<%=qiye.getRiqi()%>" size="10">
              </div>
            </div></td>
