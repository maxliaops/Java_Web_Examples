...
<html>
	...
	<body>
    	<center>
	        <table width="1000" cellpadding="0" cellspacing="0" background="images/allBack.jpg" rules="rows" border="1" rules="none" cellpadding="0" cellspacing="0" bordercolor="#4E6900" bordercolordark="white" bordercolorlight="#4E6900">
