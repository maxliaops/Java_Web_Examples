...
<tr>
    ...
    &nbsp;<span  class="word_deepgrey"> 当前位置：销售管理> </span>销售退货 &gt;&gt;&gt;</td>
  </tr>
    <tr><td valign="top" height="83"><br>
<table width="550" height="112"  border="0" align="center" cellpadding="1" cellspacing="1">
    <form  name="form1" method="post" action="spxsth.jsp" >
       <tr><td><select name="xsspname" onChange="spchange()">
        ...
        <tr><td height="25">销售票号:<font color="#585858"><%=xsthph%></font></td></tr>
        <tr><td height="25">商品名称:<font color="#585858"><%=spname%></font></td>
            <td height="25">简&nbsp;&nbsp;称:<font color="#585858"><%=jc%></font></td>
        </tr>
        <tr><td height="25">规&nbsp;&nbsp;格:<font color="#585858"><%=gg%></font></td>
            <td height="25">包&nbsp;&nbsp;装:<font color="#585858"><%=bz%></font></td>
        </tr>
        <tr><td height="25">产&nbsp;&nbsp;地:<font color="#585858"><%=cd%></font></td>
            <td height="25">进&nbsp;&nbsp;价:<font color="#585858"><%=dj%>元</font></td>
        </tr>
    </form>
    ...
    <form  name="form2" method="post" action="xsthChange.jsp" >
      ...
      %>
       <tr><td height="25">客户全称:<select name="xskhname">
          <%while(rsKh.next()){%>
          <option value="<%=rsKh.getString("khname")%>"> <%=rsKh.getString("khname")%></option>
          <%}%>
        </select></td>
        <td height="25">库存数量:<input type="text" name="kcsl"  readonly value="<%=kcsl%>">        </td></tr>
        <tr><td height="25">单&nbsp;&nbsp;&nbsp;&nbsp;价:<input type="text" name="dj" value="<%=dj%>">
              <font color="#585858">(元)</font></td>
            <td height="25">金&nbsp;&nbsp;&nbsp;&nbsp;额:<input type="text" name="je" readonly></td>
        </tr>
        <tr><td height="25">数&nbsp;&nbsp;&nbsp;&nbsp;量:<input type="text" name="sl" onBlur="autoje()">
              <font color="#585858">(<%=dw.trim()%>)*</font></td>
            <td height="25">应&nbsp;&nbsp;&nbsp;&nbsp;收:<input type="text" name="ys" readonly></td>
        </tr>
        <tr><td height="25">实&nbsp;&nbsp;&nbsp;&nbsp;收:<input type="text" name="ss" onBlur="autoje()">
              <font color="#585858">(元)*</font></td>
            <td height="25">未&nbsp;&nbsp;&nbsp;&nbsp;收:<input type="text" name="ws" readonly></td>
        </tr>
        <tr><td height="25">操&nbsp;作&nbsp;员:<input type="text" name="czy" readonly value="<%=session.getAttribute("username")%>">
              <font color="#585858"></font></td>
            <td height="25">经&nbsp;手&nbsp;人:<input type="text" name="jsr">*</td>
        </tr>
        <tr><td height="25">销售日期:<input type="text" name="xsdate" value="<%=calendar.getDate()%>">
              <font color="#585858"></font></td>
            <td height="25">结算方式:<select name="jsfs">
