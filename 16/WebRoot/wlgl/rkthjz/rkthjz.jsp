...
%>
 <form name="form1" action="rkPayFor.jsp" method="POST">
   <table width="450" height="112"  border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr><td height="25">退货票号:
          <input type="text" name="thph" readonly="readonly" value="<%=rs.getString("thph")%>">
              <font color="#585858"></font></td>
            <td>数&nbsp;&nbsp;量:<input type="text" name="sl" readonly="readonly"
                         value="<%=rs.getString("sl")%>">
              <font color="#585858"></font></td>
        </tr>
        <tr><td height="25">供应商全称:
        ...
        <tr><td height="25">实&nbsp;&nbsp;&nbsp;&nbsp;收:
          <input type="text" name="ss" readonly="readonly"
        ...
        <tr><td height="25">退货日期:
          <input type="text" name="thdate" readonly="readonly"
