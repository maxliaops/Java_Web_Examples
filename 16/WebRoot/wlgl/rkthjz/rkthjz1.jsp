...
<tr>
    ...
    &nbsp;<span  class="word_deepgrey"> 当前位置：往来管理 > </span> 入库退货结账 &gt;&gt;&gt;</td>
  </tr>
    <tr><td valign="top" height="83">
      <table width="581" height="50" border="0" cellpadding="0" cellspacing="0">
        <tr><td width="581" height="42" align="Top" background="../KCM/quest.gif">
          <form name="form1" method="POST" action="rkthjz.jsp" target="MainFrame">
