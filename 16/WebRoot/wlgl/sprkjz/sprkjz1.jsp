...
<tr>
    ...
    &nbsp;<span  class="word_deepgrey"> 当前位置：往来管理 > </span> 商品入库结账 &gt;&gt;&gt;</td>
  </tr>
    <tr><td valign="top" height="83">
      <table width="581" height="70" border="0" cellpadding="0" cellspacing="0">
        <tr><td width="581" height="42" align="Top">
          <form name="form1" method="POST" action="sprkjz.jsp" target="MainFrame">
            <div align="center">请选择查询条件:
              <select name="cif">
                <option value="gysname" selected>供应商全称</option>
                <option value="rkph">入库票号</option>
              </select>
              <select name="ccif">
