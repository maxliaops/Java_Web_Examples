...
<tr>
    ...
    &nbsp;<span  class="word_deepgrey"> 当前位置：往来管理 > </span>商品销售结账 &gt;&gt;&gt;</td>
  </tr>
    <tr><td valign="top" height="83">
      <table width="581" height="60" border="0" cellpadding="-2" cellspacing="-2">
        <tr><td width="581" height="42" align="Top" background="../KCM/quest.gif">
          <form name="form1" method="POST" action="spxsjz.jsp" target="MainFrame">
            <div align="center">请选择查询条件:
              <select name="cif">
                <option value="khname" selected>客户名称</option>
                <option value="xsph">销售票号</option>
              </select>
              <select name="ccif">
