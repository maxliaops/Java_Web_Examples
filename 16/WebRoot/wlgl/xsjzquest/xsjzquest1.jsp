...
<tr>
    ...
    &nbsp;<span  class="word_deepgrey"> 当前位置：往来管理 > </span>销售结账查询 &gt;&gt;&gt;</td>
  </tr>
    <tr><td valign="top" height="83">
      <table width="98%" height="90" border="0" cellpadding="-2" cellspacing="-2">
        <tr><td width="590" height="41" align="Top">
          <form name="form1" method="POST" action="xsjzquest.jsp" target="MainFrame">
