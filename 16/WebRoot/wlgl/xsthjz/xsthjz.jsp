...
<%
   //自动生成销售结帐最大票号
   String maxCount="select max(id) as maxid from tb_thjz_xs";
   String theMax="";
...
//——————————————————————————————————————————————————————————
   ...
   String table="tb_thph_xs";//定义需要查询的表名
   String httpFile="xsthjz.jsp";//定义处理请求的JSP文件
...
%>
     <form name="form1" action="xsthPayFor.jsp" method="POST">
   <table width="450" height="112"  border="0" align="center" cellpadding="1" cellspacing="1">
        ...
        <tr><td>实&nbsp;&nbsp;&nbsp;&nbsp;付:<input type="text" name="sf" readonly="readonly"
