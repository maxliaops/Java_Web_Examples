			   ...
			   <table width="100%" height="126"  border="0" cellpadding="0" cellspacing="0">
			    ...
			    <tr>
                  <td valign="top"><table width="100%" height="55"  border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td class="tableBorder_B"><img src="Images/index_16.gif" width="161" height="48"></td>
                    </tr>
                    <tr>
                      <td width="86%" height="100" valign="top">
						<table width="96%" height="34"  border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder_B">
                          <tr>
                            ...
                            <td width="31%" style="padding:5px;"> 出版社</td>
                            <td width="10%" style="padding:5px;">购买</td>
                          </tr>
                        </table>
                        <%while(rs_sort.next()){
			  String ISBN=rs_sort.getString("ISBN");
			  String BookName=rs_sort.getString("BookName");
			  String publisher=rs_sort.getString("publisher");
			  %>
                        <table width="96%" height="21"  border="0" align="center" cellpadding="0" cellspacing="0" class="tableBorder_B">
                          <tr>
                            ...
                            <td width="53%" style="padding:5px;"><a href="book_detail.jsp?ISBN=<%=ISBN%>"><%=BookName%></a></td>
                            <td width="31%" style="padding:5px;"><%=publisher%></td>
