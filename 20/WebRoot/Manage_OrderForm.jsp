...
<table width="744" height="526" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f9f9f9">
  <tr>
      ...
      <tr>
        <td height="544" colspan="2" valign="middle"><div align="center">
          <table width="550" height="500" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td height="50"><div align="center">订 单 信 息 管 理</div></td>
            </tr>
            <tr>
              ...
              <td height="25" valign="middle">
                <table width="480" height="20" border="0" align="center" cellpadding="0" cellspacing="0">
                  <form name="form1" method="post" action="">
                    <tr>
                      <td width="67"><div align="right">关键字：</div></td>
                      <td width="149"><input name="keyword" type="text" class="wenbenkuang" size="20"></td>
                      <td width="91"><div align="right">关键字类别：</div></td>
                      <td width="109"><select name="Type" class="wenbenkuang">
                        <option value="Name">订购车型</option>
                        <option value="LinkMan">订购用户</option>
                        <option value="Phone" selected>用户联系电话</option>
                                                                                                                                    </select></td>
            ...
            <tr>
              <td height="400" valign="top"><table width="535" height="70" border="0" align="center" cellpadding="0" cellspacing="0">
                  ...
                  <tr bgcolor="#efefef">
                    ...
                    <td width="119" height="20" class="br"><div align="center">订购车型</div></td>
                    <td width="122" class="br"><div align="center">订购时间</div></td>
                    <td width="86" height="20" class="br"><div align="center">订购用户</div></td>
	...
	sql="select * from tb_OrderForm where Whether='未受理'";
	rla="";
	}else{
	sql="select * from tb_OrderForm where Whether='未受理' and "+request.getParameter("Type")+" like '%"+request.getParameter("keyword")+"%'";
...
%>
                  <tr>
                    ...
                    <td height="20"><div align="center"><%=rs.getString("Name")%></div></td>
                    <td height="20"><div align="center"><%=rs.getDate("IssueDate")%></div></td>
                    <td height="20"><div align="center"><%=rs.getString("LinkMan")%></div></td>
                    <td height="20"><div align="center"><%=rs.getString("Phone")%></div></td>
                    <td height="20"><div align="center">
                      <input name="Submit22" type="button" class="buttons" value="受理" onClick="javascript:window.open('OrderForm_Particular.jsp?id=<%=rs.getInt("ID")%>','','width=500,height=560,toolbar=no,location=no,status=no,menubar=no')">
</div></td>
                  </tr>
                  <%}
data.close();
